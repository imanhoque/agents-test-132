...
To run this code:
    ...
    Set environment variables:
        ...
        export LLM_API_BASE_URL=your_openai_api_base_url
            (optional - default: https://api.openai.com/v1/)
        export LLM_MODEL=your_openai_model 
            (optional - default: gpt-4)
...
class ConversationalAgent:
    def __init__(self, session_name="chat"):       
        ...
        self.llm_base_url = os.getenv('LLM_API_BASE_URL', 'https://api.openai.com/v1/')
